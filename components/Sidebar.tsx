...
export function Sidebar() {
  ...
  return (
    <div className="border border-border-primary bg-white fixed top-0 left-0 lg:static p-3 lg:pl-6 lg:pt-4 gap-8 flex w-full justify-between lg:justify-normal lg:flex-col z-10">
